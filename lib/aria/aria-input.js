...
module.exports = class AriaInput extends Aria {
  get implicit() {
  ...
  get nativeLabel() {
    ...
    if (this.node.type === 'image') {
      return this.node.alt || this.node.value || '';
    }

    if (['submit', 'reset', 'button'].includes(this.node.type)) {

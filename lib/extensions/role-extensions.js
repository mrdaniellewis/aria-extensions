...
import implicit from '../aria/implicit.json';
...
ariaExtensions[symbol('extend')](Element.prototype, 'findRole', findRoleDescriptor);
ariaExtensions[symbol('extend')](HTMLDocument.prototype, 'findRole', findRoleDescriptor);

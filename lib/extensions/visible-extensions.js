...
ariaExtensions[extend](Element.prototype, 'visible', { get() {
...
ariaExtensions[extend](HTMLMapElement.prototype, 'visible', { get() {
  return this[symbols.images].some(image => image[symbols.visible]);
} });

ariaExtensions[extend](HTMLAreaElement.prototype, 'visible', { get() {
  const map = this.closest('map');
  return !!map && map[symbols.visible];
} });

ariaExtensions[extend](Element.prototype, 'ariaVisible', { get() {
